...
public interface IOrdersManager
{
    ...
    /// <param name="cancellationToken"></param>
    /// <returns>A task representing the operation. The task result contains the ID of the created order, or null if creation failed.</returns>
    Task<string> CreateLimitOrderGTCAsync(string productId, OrderSide side, decimal baseSize, decimal limitPrice, bool postOnly = true, CancellationToken cancellationToken = default);
    ...
    /// <returns>A task representing the operation. The task result contains the order object if returnOrder is true.</returns>
    /// <exception cref="ArgumentException">Thrown if returnOrder is false.</exception>
    Task<Order> CreateLimitOrderGTCAsync(string productId, OrderSide side, decimal baseSize, decimal limitPrice, bool postOnly, bool returnOrder = true, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns>A task representing the operation. The task result contains the ID of the created order, or null if creation failed.</returns>
    Task<string> CreateLimitOrderGTDAsync(string productId, OrderSide side, decimal baseSize, decimal limitPrice, DateTime endTime, bool postOnly = true, CancellationToken cancellationToken = default);
    ...
    /// <returns>A task representing the operation. The task result contains the order object if returnOrder is true.</returns>
    /// <exception cref="ArgumentException">Thrown if returnOrder is false.</exception>
    Task<Order> CreateLimitOrderGTDAsync(string productId, OrderSide side, decimal baseSize, decimal limitPrice, DateTime endTime, bool postOnly = true, bool returnOrder = true, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns>A task representing the operation. The task result contains the ID of the created order, or null if creation failed.</returns>
    Task<string> CreateStopLimitOrderGTCAsync(string productId, OrderSide side, decimal baseSize, decimal limitPrice, decimal stopPrice, CancellationToken cancellationToken);
    ...
    /// <returns>A task representing the operation. The task result contains the order object if returnOrder is true.</returns>
    /// <exception cref="ArgumentException">Thrown if returnOrder is false.</exception>
    Task<Order> CreateStopLimitOrderGTCAsync(string productId, OrderSide side, decimal baseSize, decimal limitPrice, decimal stopPrice, bool returnOrder = true, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns>A task representing the operation. The task result contains the ID of the created order, or null if creation failed.</returns>
    Task<string> CreateStopLimitOrderGTDAsync(string productId, OrderSide side, decimal baseSize, decimal limitPrice, decimal stopPrice, DateTime endTime, CancellationToken cancellationToken);
    ...
    /// <returns>A task representing the operation. The task result contains the order object if returnOrder is true.</returns>
    /// <exception cref="ArgumentException">Thrown if returnOrder is false.</exception>
    Task<Order> CreateStopLimitOrderGTDAsync(string productId, OrderSide side, decimal baseSize, decimal limitPrice, decimal stopPrice, DateTime endTime, bool returnOrder = true, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns>A task representing the operation. The task result contains the ID of the created order, or null if creation failed.</returns>
    Task<string> CreateSORLimitIOCOrderAsync(string productId, OrderSide side, decimal baseSize, decimal limitPrice, CancellationToken cancellationToken);
    ...
    /// <returns>A task representing the operation. The task result contains the order object if returnOrder is true.</returns>
    /// <exception cref="ArgumentException">Thrown if returnOrder is false.</exception>
    Task<Order> CreateSORLimitIOCOrderAsync(string productId, OrderSide side, decimal baseSize, decimal limitPrice, bool returnOrder = true, CancellationToken cancellationToken = default);
    ...
    Task<bool> EditOrderAsync(string orderId, decimal? price, decimal? size, CancellationToken cancellationToken);
    ...
    Task<EditOrderPreviewResult> EditOrderPreviewAsync(string orderId, decimal? price, decimal? size, CancellationToken cancellationToken);
